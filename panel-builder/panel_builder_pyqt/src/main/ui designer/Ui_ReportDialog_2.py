...
class Ui_ReportDialog(object):
    def setupUi(self, ReportDialog):
        ...
        self.allSystemsButten = QtWidgets.QRadioButton(self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.allSystemsButten.sizePolicy().hasHeightForWidth())
        self.allSystemsButten.setSizePolicy(sizePolicy)
        self.allSystemsButten.setObjectName("allSystemsButten")
        self.configLayout.addWidget(self.allSystemsButten)
    ...
    def retranslateUi(self, ReportDialog):
        ...
        self.allSystemsButten.setText(_translate("ReportDialog", "All Systems"))
